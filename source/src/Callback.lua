...
{
{text = '⌁ 𝑺𝑶𝑼𝑹𝑪𝑬 𝑺𝑨𝑰𝑫𝑰 ⚡', url="t.me/S_a_i_d_i"},
},
}
}
...
if tonumber(IdUser) == tonumber(UserId) then
au ={type = "photo",media = "https://t.me/DEV_JABWA/202",caption = '*╭───── •*[ ⍟ ](t.me/S_a_i_d_i )*• ─────╮\n├ ⍟  قم بختيار نوع الاغنيه 🎧\n╰───── •*[ ⍟ ](t.me/S_a_i_d_i )*• ─────╯\n✦ 𝑺𝑶𝑼𝑹𝑪𝑬 𝑺𝑨𝑰𝑫𝑰  𝑩𝑬𝑻𝑻𝑬𝑹 ⏎*\n',parse_mode = "Markdown"}     
...
local Text =' ✧ قم باستعمال الازرار لرفع العضو ⇞⇟\n ✧ العضو ⇿ ['..UserInfo.first_name..'](t.me/'..(UserInfo.username or 'S_a_i_d_i')..')'
...
txxt = ' ✧ العضو ⇿ ['..UserInfo.first_name..'](t.me/'..(UserInfo.username or 'S_a_i_d_i')..')\n ✧ تم رفعه في قائمة المميزين'
local reply_markup = bot.replyMarkup{
type = 'inline',
data = {
...
keyboard.inline_keyboard = {
{
{text = '⌁ 𝑺𝑶𝑼𝑹𝑪𝑬 𝑺𝑨𝑰𝑫𝑰 ⚡', url = "http://t.me/S_a_i_d_i"},
},
{
...
keyboard.inline_keyboard = {
{
{text = '⌁ 𝑺𝑶𝑼𝑹𝑪𝑬 𝑺𝑨𝑰𝑫?? ⚡', url = 't.me/S_a_i_d_i'}, 
},
}
local mm = Msg_id/2097152/0.5
https.request("http://api.telegram.org/bot"..Token.."/editmessagemedia?chat_id="..ChatId.."&message_id="..mm.."&media="..JSON.encode(au).."&reply_markup="..JSON.encode(keyboard))
...
if tonumber(IdUser) == tonumber(UserId) then
au ={type = "photo",media = "https://t.me/S_a_i_d_i/1018",caption = '*الاجابه صحيحه استمر باللعب ✅*\n',parse_mode = "Markdown"}     
local bain = bot.getUser(IdUser)
keyboard = {} 
keyboard.inline_keyboard = {
{
...
if tonumber(IdUser) == tonumber(UserId) then
au ={type = "photo",media = "https://t.me/DEV_JABWA/126",caption = '*1 إذا علمت أن جد جابوا توفي سنة 1872 م\n2 : وأن جابوا توفي بعد ميلاد جده بمقدار 131 سنة\n3 وإن مجموع عمري جابوا وجده 105 سنوات\nففي أي سنة ولد جابوا؟*\n',parse_mode = "Markdown"}     
local bain = bot.getUser(IdUser)
keyboard = {} 
keyboard.inline_keyboard = {
{
...
if tonumber(IdUser) == tonumber(UserId) then
au ={type = "photo",media = "https://t.me/S_a_i_d_i/1018",caption = '*مبروك عاش عليك تم إنهاء العبه بنجاح ✅*\n',parse_mode = "Markdown"}     
local bain = bot.getUser(IdUser)
keyboard = {} 
keyboard.inline_keyboard = {
{
...
if tonumber(IdUser) == tonumber(UserId) then
au ={type = "photo",media = "https://t.me/S_a_i_d_i/602",caption = '*• يلا بنا نبحث عن المنزل •*\n',parse_mode = "Markdown"}     
keyboard = {} 
keyboard.inline_keyboard = {
{
...
if tonumber(IdUser) == tonumber(UserId) then
au ={type = "photo",media = "https://t.me/S_a_i_d_i/602",caption = '*• في صوت هل صدر من الامام ام الخلف •*\n',parse_mode = "Markdown"}     
keyboard = {} 
keyboard.inline_keyboard = {
{
...
if tonumber(IdUser) == tonumber(UserId) then
au ={type = "photo",media = "https://t.me/S_a_i_d_i/602",caption = '*• هيا بنا نذهب الي الامام لنرا المنزل •*\n',parse_mode = "Markdown"}     
keyboard = {} 
keyboard.inline_keyboard = {
{
...
if tonumber(IdUser) == tonumber(UserId) then
au ={type = "photo",media = "https://t.me/S_a_i_d_i/602",caption = '*• هيا بنا نذهب الي الخلف لنرا المنزل •*\n',parse_mode = "Markdown"}     
keyboard = {} 
keyboard.inline_keyboard = {
{
{text = '𓄼• هيا •𓄹', callback_data=IdUser.."/have"},
...
if tonumber(IdUser) == tonumber(UserId) then
au ={type = "photo",media = "https://t.me/S_a_i_d_i/602",caption = '*• لقد وصلنا الى المنزل شكراَ جزيلَ انتطرني ثواني وسوف اعود •*\n',parse_mode = "Markdown"}     
keyboard = {} 
keyboard.inline_keyboard = {
{
...
if tonumber(IdUser) == tonumber(UserId) then
au ={type = "photo",media = "https://t.me/S_a_i_d_i/602",caption = '*• لقد عودت إليك ظهر شيئ •*\n',parse_mode = "Markdown"}     
keyboard = {} 
keyboard.inline_keyboard = {
{
...
if tonumber(IdUser) == tonumber(UserId) then
au ={type = "photo",media = "https://t.me/S_a_i_d_i/602",caption = '*• هيا نذهب داخل المنزل •*\n',parse_mode = "Markdown"}     
keyboard = {} 
keyboard.inline_keyboard = {
{
...
if tonumber(IdUser) == tonumber(UserId) then
au ={type = "photo",media = "https://t.me/S_a_i_d_i/602",caption = '*•  نحنو نتوه في هذه المكان •*\n',parse_mode = "Markdown"}     
keyboard = {} 
keyboard.inline_keyboard = {
{
...
if tonumber(IdUser) == tonumber(UserId) then
au ={type = "photo",media = "https://t.me/S_a_i_d_i/602",caption = '*• لا يوجد ضواء في هذا المكان •*\n',parse_mode = "Markdown"}     
keyboard = {} 
keyboard.inline_keyboard = {
{
...
if tonumber(IdUser) == tonumber(UserId) then
au ={type = "photo",media = "https://t.me/S_a_i_d_i/602",caption = '*• تعالى نذهب الي الباب الرئيسي •*\n',parse_mode = "Markdown"}     
keyboard = {} 
keyboard.inline_keyboard = {
{
...
if tonumber(IdUser) == tonumber(UserId) then
au ={type = "photo",media = "https://t.me/S_a_i_d_i/602",caption = '*• انها النهاية هتكمل ولا لا •*\n',parse_mode = "Markdown"}     
keyboard = {} 
keyboard.inline_keyboard = {
{
...
if tonumber(IdUser) == tonumber(UserId) then
au ={type = "photo",media = "https://t.me/S_a_i_d_i/602",caption = '*• سارسل اليك  سوال مع اختيارت لو حليت صح ستنجو من العقاب لو خطأ سيقوم عليك العقاب •\nالسوال هوا - شيء لا يتأثر بالماء حتى عندما يمر من خلالها فمن يكون؟*\n',parse_mode = "Markdown"}     
keyboard = {} 
keyboard.inline_keyboard = {
{
...
if tonumber(IdUser) == tonumber(UserId) then
au ={type = "photo",media = "https://t.me/S_a_i_d_i/602",caption = '*• مبروك لقد فوزت ونجيت من العقاب •*\n',parse_mode = "Markdown"}     
keyboard = {} 
keyboard.inline_keyboard = {
{
...
if tonumber(IdUser) == tonumber(UserId) then
au ={type = "photo",media = "https://t.me/S_a_i_d_i/602",caption = '*• غلط القاب هوا خلاص سامحتك •*\n',parse_mode = "Markdown"}     
keyboard = {} 
keyboard.inline_keyboard = {
{
{text = '〘 ❌ 〙', callback_data=IdUser.."/01ahakaka"},
...
if tonumber(IdUser) == tonumber(UserId) then
au ={type = "photo",media = "https://t.me/S_a_i_d_i/602",caption = '*• غلط القاب هوا سكر خشمك و قول كلمة من اختيار  الاعبين الي معك •*\n',parse_mode = "Markdown"}     
keyboard = {} 
keyboard.inline_keyboard = {
{
{text = '〘 ❌ 〙', callback_data=IdUser.."/01ahakaka"},
...
if tonumber(IdUser) == tonumber(UserId) then
au ={type = "photo",media = "https://t.me/S_a_i_d_i/602",caption = '*• غلط القاب هوا اذهب الى واحد ماتعرفه وقل له انا كيوت وابي بوسه •*\n',parse_mode = "Markdown"}     
keyboard = {} 
keyboard.inline_keyboard = {
{
{text = '〘 ❌ 〙', callback_data=IdUser.."/01ahakaka"},
...
if tonumber(IdUser) == tonumber(UserId) then
au ={type = "photo",media = "https://t.me/S_a_i_d_i/602",caption = '*• غلط القاب هوا روح المطبخ و اكسر صحن او كوب •*\n',parse_mode = "Markdown"}     
keyboard = {} 
keyboard.inline_keyboard = {
{
{text = '〘 ❌ 〙', callback_data=IdUser.."/01ahakaka"},
...
if tonumber(IdUser) == tonumber(UserId) then
au ={type = "photo",media = "https://t.me/S_a_i_d_i/602",caption = '*• غلط القاب هوا تتصل على الوالده و تقول لها تزوجت با سر •*\n',parse_mode = "Markdown"}     
keyboard = {} 
keyboard.inline_keyboard = {
{
{text = '〘 ❌ 〙', callback_data=IdUser.."/01ahakaka"},
...
if tonumber(IdUser) == tonumber(UserId) then
au ={type = "photo",media = "https://t.me/S_a_i_d_i/602",caption = '*• انت ستندم سأقتلك •*\n',parse_mode = "Markdown"}     
keyboard = {} 
keyboard.inline_keyboard = {
{
{text = '〘 ❌ 〙', callback_data=IdUser.."/01ahakaka"},
