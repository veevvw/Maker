...
local t = '*✧ عشان تسوي حساب لازم تختار نوع البطاقة*\n\n[🎮 𝑮َ𝑨َ𝑴َ𝑬 𝑩َ𝑨َ𝑵َ𝑲 𝑺َ𝑶َ𝑼َ𝑹َ𝑪َ𝑬 𝑺َ𝑨َ𝑰َ𝑫َ𝑰 ⚡](t.me/S_a_i_d_i )'
local m = "https://t.me/S_a_i_d_i/3233" 
keyboard = {} 
keyboard.inline_keyboard = {
{
{text = 'جابوا 💗', callback_data=senderr..'/master'},{text = 'الاهلي ⚽', callback_data=senderr..'/visaa'},{text = 'صعيدي 👑', callback_data=senderr..'/express'},
},
{
{text='⌁ 𝑺𝑶𝑼𝑹𝑪𝑬 𝑺𝑨𝑰𝑫𝑰 ⚡',url='t.me/'..chsource..''},
}
}
